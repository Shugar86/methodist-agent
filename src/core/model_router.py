...
class ModelRouter:
    ...
    def chat(
        ...
        try:
            if provider in ["openai", "ollama"]:
                return self._chat_openai(client, messages, model_config, temperature, max_tokens, tools, stream)
            elif provider == "anthropic":
                return self._chat_anthropic(client, messages, model_config, temperature, max_tokens, tools, stream)
            else:
    ...
    def _chat_anthropic(self, client, messages, model_config, temperature, max_tokens, tools, stream):
